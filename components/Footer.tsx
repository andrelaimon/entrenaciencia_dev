    ...
    <>
      ...
      <section className="contact" id="contacto">
        ...
        <div className="section-inner" style={{ maxWidth: '720px' }}>
          ...
          <a
            href="mailto:contacto@entrenaciencia.com"
            style={{
              ...
              textDecoration: 'none',
              borderBottom: '1px solid rgba(1,127,167,0.3)',
              paddingBottom: '2px',
            }}
          >
            contacto@entrenaciencia.com
          </a>

          <div className="social-links">
            {/* Instagram */}
            <a href="https://www.instagram.com/entrena.con.ciencia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            {/* TikTok */}
            <a href="https://www.tiktok.com/@entrenaciencia" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
              <svg viewBox="0 0 24 24">
